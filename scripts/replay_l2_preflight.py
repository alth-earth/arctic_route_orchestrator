"""Run GEBCO L2 coastline preflight on an authoritative replay artifact."""
...
from arctic_route_orchestrator.replay.preflight import run_l2_preflight


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="replay-l2-preflight")
